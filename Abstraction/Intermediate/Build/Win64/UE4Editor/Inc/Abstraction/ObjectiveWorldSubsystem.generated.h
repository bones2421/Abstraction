...
public: \
	DECLARE_CLASS(UObjectiveWorldSubsystem, UWorldSubsystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Abstraction"), NO_API) \
...
#define Abstraction_Source_Abstraction_Public_ObjectiveWorldSubsystem_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UObjectiveWorldSubsystem); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UObjectiveWorldSubsystem); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UObjectiveWorldSubsystem(UObjectiveWorldSubsystem&&); \
	NO_API UObjectiveWorldSubsystem(const UObjectiveWorldSubsystem&); \
public:
...
template<> ABSTRACTION_API UClass* StaticClass<class UObjectiveWorldSubsystem>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Abstraction_Source_Abstraction_Public_ObjectiveWorldSubsystem_h
